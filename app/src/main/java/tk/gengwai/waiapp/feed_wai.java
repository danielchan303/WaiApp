...
public class feed_wai extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_feed_wai);
        // Set hotPepper Drag Action
        ImageView hotPepper = (ImageView) findViewById(R.id.hot_pepper);
        ...
        // Set poo Drag Action
        ImageView poo = (ImageView) findViewById(R.id.poo);
        poo.setOnTouchListener(new feedFood());

        // Set Drop Action
        ImageView wai = (ImageView) findViewById(R.id.wai);
